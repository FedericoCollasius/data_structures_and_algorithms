...
/*
3 cosas:
        . Caso crear una lista nueva igual a una prexisente  --> vas creando nodos a medida que los necesitas
        . asignar en una posicion donde habia un nodo un valor -->
        . pisar memoria prexistente

       otra = 0 <- 42 <-> 43 <-> 44 <-> 45 -> 0;
       l    = 0 <- 43 <-> 44 <-> 45 -> 0;
*/
